    ...
    public class SocietesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Societe != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Societe'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Lib,Adress,Tel")] Societe societe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Lib,Adress,Tel")] Societe societe)
        {
            if (id != societe.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Societe'  is null.");
            }
            var societe = await _context.Societe.FindAsync(id);
            if (societe != null)
            {
